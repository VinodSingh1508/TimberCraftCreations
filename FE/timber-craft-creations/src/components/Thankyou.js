                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 text-center pt-5">
                            ...
                            <p className="lead mb-5">You order was successfuly completed. You can view your orders under you profile.</p>
                            <p><Link to={`/shop`} className="btn btn-sm btn-outline-black">
                                Continue Shopping
                            </Link></p>
                        </div>
                    </div>
